...
#define TIMESTAMP_DIFF_MONTH_UNITS(TYPE, NAME, N_MONTHS) \
  ...
  int32 NAME##_##TYPE##_##TYPE(TYPE start_millis, TYPE end_millis) { \
    ...
    int32 months_diff; \
    months_diff = 12 * (end_tm.tm_year - start_tm.tm_year) + \
    ...
    int32 end_day_millis = end_tm.tm_hour * MILLIS_IN_HOUR + \
                           end_tm.tm_min * MILLIS_IN_MIN + \
                           end_tm.tm_sec; \
    int32 start_day_millis = start_tm.tm_hour * MILLIS_IN_HOUR + \
                             start_tm.tm_min * MILLIS_IN_MIN + \
                             start_tm.tm_sec; \
