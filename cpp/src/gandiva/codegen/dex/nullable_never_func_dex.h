 ...
 */
#ifndef GANDIVA_DEX_NULLABLENEVERFUNCDEX_H
#define GANDIVA_DEX_NULLABLENEVERFUNCDEX_H
...
/**
 * A function expression that deals with null inputs, but always outputs non-null values.
 */
...
#endif //GANDIVA_DEX_NULLABLENEVERFUNCDEX_H
